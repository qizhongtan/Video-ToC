...
The SFT part is based on [LlamaFactory](https://github.com/hiyouga/LlamaFactory), and the RL part is based on [EasyR1](https://github.com/hiyouga/EasyR1), and the eval part is based on [Video-R1](https://github.com/tulerfeng/Video-R1). Thanks for their awesome work!
...
@article{tan2026video,
  ...
  author={Tan, Qizhong and Zhuotao Tian and Lu, Guangming and Jun Yu and Pei, Wenjie},
